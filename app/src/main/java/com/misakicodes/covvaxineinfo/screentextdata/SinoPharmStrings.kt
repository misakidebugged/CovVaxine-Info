...
val detailsInFullSinoPharm = "The Sinopharm Vaccine or BBIBP-CorV has been developed by the " +
        "Beijing Bio-Institute of Biological Products(BBIBP) in collaboration with the Sinopharm " +
        "Vaccine or BBIBP-CorV. The vaccine was given authorization by China's National " +
        "Medical Products Administration on 31st December 2020 and its emergency use " +
        "against SARS-CoV-2 by the World Health Organization on 7th May 2021\n\n" +
        "It is an inactivated virus Covid-19 vaccine. It uses a killed or inactivated " +
        "virus which is made to enter the body by means of a vaccine. " +
...
val webpageSinoPharm = "https://en.wikipedia.org/wiki/Sinopharm_BIBP_COVID-19_vaccine"