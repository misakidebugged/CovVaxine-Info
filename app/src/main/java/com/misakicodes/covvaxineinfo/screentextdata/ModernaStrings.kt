...
val controversiesModerna = "A Lot of controversy comes from the fact SpikeVax (Moderna) is an mRNA vaccine, Before 2020 " +
        "no mRNA technology platform (drug or vaccine) had been authorized for use in humans, " +
        "so there has always been a risk of unknown effects. 3 years of ongoing tests are still insufficient to " +
        "conclude them as \"safe\" but due to the emergency of the Covid crisis they had to be approved to meet " +
        "the required number of people that to be vaccinated for normal life to resume. \n\n" +
        "Nevertheless, so far its side effects do not differ much to those of traditional vaccines and have " +
        "proven themselves as very effective vaccines."

val webpageModerna = "https://en.wikipedia.org/wiki/Moderna_COVID-19_vaccine"